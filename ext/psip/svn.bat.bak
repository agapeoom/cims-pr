TortoiseProc.exe /command:update /path:"C:\OpenProject\CppHttpStack\" /closeonend:1
TortoiseProc.exe /command:update /path:"C:\OpenProject\CppSipStack\" /closeonend:1
